...
public class LowCardinalityStructTest extends PlanTestBase {
    ...
    public void testExpressionNonDictField() throws Exception {
        String sql = """
                ...
                """;
        String plan = getVerboseExplain(sql);
        String expected = "row[([6: VARCHAR_COL, INT, true], [4: INTEGER_COL, INT, true]); args: INT,INT; result: " +
                "struct<`col1` int(11), `col2` int(11)>; args nullable: true; result nullable: true].col2[true]";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
    ...
    public void testExpressionAllFields() throws Exception {
        ...
        String expected = "  1:Project\n" +
                ...
                "  |  8 <-> row[([9: VARCHAR_COL, INT, true], [10: ARRAY_VARCHAR_COL, ARRAY<INT>, true], " +
                "[4: INTEGER_COL, INT, true]); args: INT,INVALID_TYPE,INT; result: struct<`col1` int(11), " +
                "`col2` array<int(11)>, `col3` int(11)>; args nullable: true; result nullable: true].col3[true]\n";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
    ...
    public void testNamedStructGetFields() throws Exception {
        ...
        String expected = "  1:Project\n" +
                ...
                "named_struct[('c1', [9: VARCHAR_COL, INT, true], 'c2', [10: ARRAY_VARCHAR_COL, ARRAY<INT>, true], " +
                "'c3', [4: INTEGER_COL, INT, true]); args: VARCHAR,INT,VARCHAR,INVALID_TYPE,VARCHAR,INT; result: " +
                "struct<`c1` int(11), `c2` array<int(11)>, `c3` int(11)>; args nullable: true; result nullable: true]" +
                ".c2[true])\n" +
                "  |  8 <-> named_struct[('c1', [9: VARCHAR_COL, INT, true], 'c2', [10: ARRAY_VARCHAR_COL, " +
                "ARRAY<INT>, true], 'c3', [4: INTEGER_COL, INT, true]); args: VARCHAR,INT,VARCHAR,INVALID_TYPE," +
                "VARCHAR,INT; result: struct<`c1` int(11), `c2` array<int(11)>, `c3` int(11)>; args nullable: true;" +
                " result nullable: true].c3[true]\n";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
